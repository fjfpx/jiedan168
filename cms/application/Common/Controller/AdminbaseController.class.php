...
class AdminbaseController extends AppframeController {
    ...
    protected function page($total_size = 1, $page_size = 0, $current_page = 1, $listRows = 6, $pageParam = '', $pageLink = '', $static = FALSE) {
        ...
        $Page->SetPager('Admin', '{first}{prev}&nbsp;{liststart}{list}{listend}&nbsp;{next}{last}{jump}', array("listlong" => "9", "first" => "首页", "last" => "尾页", "prev" => "上一页", "next" => "下一页", "list" => "*", "disabledclass" => ""));
        return $Page;
    }
    ...
    //add log
    protected function logs($msg,$bid,$type=0){
        if($msg=='' || !isset($msg)){
            return;
        }
        $data = array(
