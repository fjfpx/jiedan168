...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:;">逾期列表</a></li>
		</ul>
			...
			<table class="table table-hover table-bordered table-list">
				<thead>
                    ...
                    <?php if(is_array($item['item'])): foreach($item['item'] as $key=>$it): ?><tr>
                        ...
                        <?php $status = array('待打款','待还款','已到期','已还款','<font color="red">已逾期</font>','逾期还款'); ?>
                        <td><?php echo ($status[$it['status']]); ?></td>
                        <td><?php echo ($it["user_login"]); ?></td>
                        <td><?php echo ($it["verify_user"]); ?></td>
                        <td><?php echo ($it["overdue"]); ?> 天</td>
                        <td>
                            <a href="<?php echo U('AdminLoan/detail',array('id'=>$it['id'],'op'=>2));?>" >详细资料</a>&emsp;
                            <a href="<?php echo U('AdminLoan/repay',array('id'=>$it['id']));?>">还款</a>
                        </td>
