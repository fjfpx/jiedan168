...
<meta charset="utf-8">
<title>借蛋 <?php echo L('ADMIN_CENTER');?></title>
...
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/tpl_admin/simpleboot/Public/assets/images/logo-18.png">
						借蛋 <?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="javascript:;" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
						<i class="fa fa-home"></i>
					</a>
					
					<a class="btn btn-small btn-success" href="javascript:;" title="<?php echo L('PORTAL_ADMINTERM_INDEX');?>">
						<i class="fa fa-th"></i>
					</a>
					
					<a class="btn btn-small btn-info" href="javascript:;" title="<?php echo L('PORTAL_ADMINPOST_INDEX');?>">
						<i class="fa fa-pencil"></i>
					</a>

					<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/clearcache')): ?><a class="btn btn-small btn-danger" href="javascript:;" title="<?php echo L('ADMIN_SETTING_CLEARCACHE');?>">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/tpl_admin/simpleboot/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/tpl_admin/simpleboot/Public/assets/js/index.js"></script>
</body>
</html>