...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('User/edit_post_ord');?>">
			<fieldset>
                <!--
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="user_type">
                            <option value="2" <?php if($user_type==2): ?>selected<?php endif; ?>>普通用户</option>
                            <option value="1" <?php if($user_type==1): ?>selected<?php endif; ?>>普通管理员用户</option>
                        </select>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="utype">
                            <option value="0" <?php if($utype==0): ?>selected<?php endif; ?>>普通账户</option>
                            <option value="1" <?php if($utype==1): ?>selected<?php endif; ?>>苹果审核账户</option>
                        </select>
                    </div>
                </div>
			</fieldset>
