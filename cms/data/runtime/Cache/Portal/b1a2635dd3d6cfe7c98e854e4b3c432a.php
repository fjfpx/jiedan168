				...
				<div class="span9" style="width:90%">
                    <table class="table table-bordered" id="jiben">
                        ...
                        <tr>
                            <th>运营商认证</th>
                            <td>
                                <?php if($info['phone_status']==1): ?><a href="<?php echo U('AdminCredit/base_phone',array('uid'=>$info['user_id']));?>" target="_blank">基础信息</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('AdminCredit/moxie_phone',array('uid'=>$info['user_id']));?>" target="_blank">魔蝎报告</a>
                                <?php else: ?>
                                    未认证<?php endif; ?>
                            </td>
                            <th></th>
                        ...
                        <tr>
                            <th>支付宝认证</th>
                            <td>
                                <?php if($info['alipay_status']==1): ?><a href="<?php echo U('AdminCredit/base_alipay',array('uid'=>$info['user_id']));?>" target="_blank">基础信息</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('AdminCredit/moxie_alipay',array('uid'=>$info['user_id']));?>" target="_blank">魔蝎报告</a>
                                <?php else: ?>
                                    未认证<?php endif; ?>
                            </td>
                            <th>淘宝认证</th>
                            <td>
                                <?php if($info['taobao_status']==1): ?><a href="<?php echo U('AdminCredit/base_taobao',array('uid'=>$info['user_id']));?>" target="_blank">基础信息</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('AdminCredit/moxie_taobao',array('uid'=>$info['user_id']));?>" target="_blank">魔蝎报告</a>
                                <?php else: ?>
                                    未认证<?php endif; ?>   
                            </td>
                        </tr>
                    ...
                    <table class="table table-bordered" id="jiben">
                        ...
                        <tr>
                            <th>常驻地址</th>
                            <td><?php echo ($info["family_addr"]); ?></td>
                            <th>申请IP</th>
                            <td><?php echo ($info["mbaddip"]); ?></td>
                            <th>定位</th>
                            <td><?php echo ($info["ip_addr"]); ?></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                    <table class="table table-bordered" id="danwei">
                        ...
                        <tr>
                            <th>单位名称</th>
                            <td><?php echo ((isset($info["company"]) && ($info["company"] !== ""))?($info["company"]):"无"); ?></td>
                            <th>单位电话</th>
                            <td><?php echo ((isset($info["company_tel"]) && ($info["company_tel"] !== ""))?($info["company_tel"]):"无"); ?></td>
                            <th>单位地址</th>
                            <td><?php echo ((isset($info["company_addr"]) && ($info["company_addr"] !== ""))?($info["company_addr"]):"无"); ?></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                    <table class="table table-bordered" id="jinji">
                        <tr><td><h5>紧急联系人信息</h5></td></tr>
                        <?php if(is_array($info['contact'])): foreach($info['contact'] as $n=>$ic): ?><tr>
                            <th>关系</th>
                            <td><?php echo ($ic["1"]); ?></td>
                            <th>姓名</th>
                            <td><?php echo ($ic["2"]); ?></td>
                    ...
                    <table class="table table-bordered" id="yinhangka">
                        <tr><td><h5>银行卡信息</h5><br />银行卡四要素验证 <?php if($info['mkverify_status']=='1'): ?><font color="green">一致</font><?php else: ?><font color="red">不一致</font><?php endif; ?></td></tr>
                        <tr>
                            <th>卡号</th>
                            <td><?php echo ($info["card"]); ?></td>
                            <th>银行</th>
                            <td><?php echo ($info["bankname"]); ?></td>
                            <th>开户行</th>
                            <td><?php echo ($info["branch"]); ?></td>
                            <th>预留手机号</th>
                            <td><?php echo ($info["mkphone"]); ?></td>
                        </tr>
                    </table>

                    <p>&nbsp;</p>
                    <table class="table table-bordered" id="shenfen">
                        <tr><td><h5>身份认证</h5><br />身份核验 <?php if($info['real_status']=='1'): ?><font color="green">一致</font><?php else: ?><font color="red">不一致</font><?php endif; ?></td></tr>
                        <tr>
                            <th>
                                <?php if($info['front_pic']!=''): ?><a href="<?php echo ($info["front_pic"]); ?>" target="_blank"><img src="<?php echo ($info["front_pic"]); ?>" width="135" style="cursor: hand" /></a>
                                <?php else: ?>
                                    <img src="/tpl_admin/simpleboot/Public/assets/images/default-thumbnail.png" width="135" style="cursor: hand"/><?php endif; ?>
                            </th>
                            <th>
                                <?php if($info['behind_pic']!=''): ?><a href="<?php echo ($info["behind_pic"]); ?>" target="_blank"><img src="<?php echo ($info["behind_pic"]); ?>" width="135" style="cursor: hand" /></a>
                                <?php else: ?>
                                    <img src="/tpl_admin/simpleboot/Public/assets/images/default-thumbnail.png" width="135" style="cursor: hand"/><?php endif; ?>
                            </th>
                        </tr>
                    ...
                    <table class="table table-bordered" id="shixin">
                        ...
                        <?php if($info['dis_status']==1 && $info['is_dis']==1): if(is_array($info['discredit'])): foreach($info['discredit'] as $n=>$idis): if(is_array($idis)): foreach($idis as $s=>$sx): ?><td>类型</td>
                                <td>案号</td>
                                <td>立案时间</td>
                                <td>内容</td>
                                <tr>
                    ...
                    <table class="table table-bordered" id="fumian">
                        ...
                        <?php if($info['neg_status']==1 && $info['is_neg']==1): ?><tr>
                            <th>是否在逃</th>
                            <th>是否有前科</th>
                            <th>是否吸毒</th>
                            <th>是否涉毒</th>
                        ...
                        <tr>
                            <td><?php if($info['negative']['escapeCompared']=='1'): ?>是<?php else: ?>否<?php endif; ?> </td>
                            <td><?php if($info['negative']['crimeCompared']=='1'): ?>是<?php else: ?>否<?php endif; ?> </td>
                            <td><?php if($info['negative']['drugCompared']=='1'): ?>是<?php else: ?>否<?php endif; ?></td>
                            <td><?php if($info['negative']['drugRelatedCompared']=='1'): ?>是<?php else: ?>否<?php endif; ?></td>
                            <td><?php echo ($info['negative']['caseType']); ?></td>
                        </tr><?php endif; ?>
                    </table>
                    ...
                    <table class="table table-bordered" id="hidden-books">
                        <tr><td><h5>通讯录 (共<?php echo ($info["book_nums"]); ?>条)&emsp; <a href="javascript:;" onclick="chgbooksshow()">点击展开</a></h5></td></tr>
                    </table>
                    <div id="show-books" style="display:none;">
                    <p>&nbsp;</p>
                    <table class="table table-bordered">
                        <tr><td><h5>通讯录 (共<?php echo ($info["book_nums"]); ?>条)&emsp; <a  href="javascript:;" onclick="chgbooksup()">点击收起</a></h5></td></tr>
                        <tr>
                            <th>姓名</th>
                            <th>电话</th>
                        </tr>
                        <?php if(is_array($info['book'])): foreach($info['book'] as $n=>$ibook): ?><tr>
                    ...
                    <table class="table table-bordered" id="beizhu">
                        ...
                        <?php if(is_array($info['remark'])): foreach($info['remark'] as $n=>$ir): ?><tr>
